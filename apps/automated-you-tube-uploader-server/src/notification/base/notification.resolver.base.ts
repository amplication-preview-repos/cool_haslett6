...
export class NotificationResolverBase {
  ...
  @graphql.Query(() => [CreateNotificationDto])
  async GetAllNotifications(
    @graphql.Args()
    args: CreateNotificationDto
  ): Promise<CreateNotificationDto[]> {
    return this.service.GetAllNotifications(args);
  }
  ...
  async GetNotificationById(
    ...
    return this.service.GetNotificationById(args);
  }

  @graphql.Mutation(() => CreateNotificationDto)
  async NotifyUser(
    @graphql.Args()
    args: CreateNotificationDto
  ): Promise<CreateNotificationDto> {
